...
export default function Netflix() {
    ...
    const id = '-NOQFV4o7ZV2Xzae7eSr-A';
                        ...
                        <div className=' rounded-xl xl:w-96 lg:w-96 lg:h-72'>
                            <div className='xl:px-5 xl:py-6 '>
                                ...
                                <div className='flex flex-cols-2 gap-2 mt-3'>
                                    <div>
                                        <a href="https://apps.apple.com/us/app/netflix/id363590051" target="_blank" rel="noopener noreferrer">
                                            <img src="https://d1qgcmfii0ptfa.cloudfront.net/S/content/mobile/images/app_store_coda.png" alt="" />
                                        </a>
                                    </div>
                                    <div>
                                        <a href="https://play.google.com/store/apps/details?id=com.netflix.mediaclient&hl=id&gl=US" target="_blank" rel="noopener noreferrer">
                        ...
                        <div>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className='border border-gray-200 rounded-xl shadow-lg bg-white xl:mt-2 lg:mt-0 md:mt-5 xs:mt-5 xss:mt-5'>
                                    <div className='xl:px-5 xl:py-5 lg:px-5 lg:py-5 md:px-5 md:py-5 sm:px-5 sm:py-5 xs:px-2 xs:py-2 mb-3'>
                                        <div className='font-bold text-lg'>
                                            <span className='border border-indigo-500 bg-indigo-500 px-2 text-white rounded-full'>1</span>&nbsp;Pilih Voucher
                                        </div>
                                ...
                                <div className='border border-gray-200 rounded-xl shadow-lg bg-white xl:mt-2 lg:mt-0 md:mt-5 xs:mt-5 xss:mt-5'>
                                    <div className='xl:px-5 xl:py-5 lg:px-5 lg:py-5 md:px-5 md:py-5 sm:px-5 sm:py-5 xs:px-2 xs:py-2 mb-3'>
                                        <div className='font-bold text-lg'>
                                            <span className='border border-indigo-500 bg-indigo-500 px-2 text-white rounded-full'>2</span>&nbsp;Pilih Pembayaran
                                        </div>
                                ...
                                <div className='border border-gray-200 rounded-xl shadow-lg bg-white xl:mt-2 lg:mt-0 md:mt-5 xs:mt-5 xss:mt-5'>
                                    <div className='xl:px-5 xl:py-5 lg:px-5 lg:py-5 md:px-5 md:py-5 sm:px-5 sm:py-5 xs:px-2 xs:py-2 mb-3'>
                                        <div className='font-bold text-lg'>
                                            <span className='border border-indigo-500 bg-indigo-500 px-2 text-white rounded-full'>3</span>&nbsp;Beli
                                        </div>
                                        <div>
                    ...
                    <div className='grid xl:grid-cols-2 lg:grid-cols-2 xl:px-52 lg:px-32 md:px-5 sm:px-5 xs:px-2 mt-3'>
                        <div className=' rounded-xl xl:w-96 lg:w-96 lg:h-72'>
                            <div className='xl:px-5 xl:py-6 '>
                                ...
                                <div className='flex flex-cols-2 gap-2 mt-3'>
                                    <div>
                                        <a href="https://apps.apple.com/id/app/youtube/id544007664?l=id" target="_blank" rel="noopener noreferrer">
                                            <img src="https://d1qgcmfii0ptfa.cloudfront.net/S/content/mobile/images/app_store_coda.png" alt="" />
                                        </a>
                                    </div>
                                    <div>
                                        <a href="https://play.google.com/store/apps/details?id=com.google.android.youtube&hl=id&gl=US" target="_blank" rel="noopener noreferrer">
                                            <img src="https://d1qgcmfii0ptfa.cloudfront.net/S/content/mobile/images/google_play_coda.png" alt="" />
                                        </a>
                                    </div>
                                </div>
